...
cercles.forEach(cercle => {
    ...
    // not an arrow function in order to use 'this'
    // fonctions fléchés font appel au context englobant
    // alors que fonctions classiques font appel au contexte appelant
