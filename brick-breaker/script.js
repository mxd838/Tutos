    ...
    for (let i = 0; i < nbRow; i++){
        for (let j = 0; j < nbCol; j++){
            ...
            if(briques[i][j].statut === 1){
                ...
                // 75 * 8 = 600 : largeur de brique * nombre de briques
                // 35 * 2 = 70  : décalages par rapport aux bords de l'écran
                // 10 * 8 = 80  : espace entre chaque brique
                // 600 + 70 + 80 = 750 : largeur du canvas 
    ...
    if (fin === false){
        ...
        if(y + vitesseY > canvas.height - rayonBalle){
            ...
            if ( x > barreX && x < barreX + barreWidth){
                ...
                fin = true
                affichageScore.innerHTML = `Perdu! Clique sur le casse-briques pour recommencer.`
            }
        }
